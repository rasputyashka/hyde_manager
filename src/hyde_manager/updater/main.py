...
from hyde_manager.app.widgets.base import CustomOption, CustomOptionList


class Installer(AppContainer):
    def compose(self) -> ComposeResult:
        self.description_label = Static("", classes="option-info m-1 p-1")
        self.option_list = CustomOptionList(
            CustomOption("foo", "foo description"),
            CustomOption("bar", "bar description"),
            CustomOption("baz", "baz description"),
